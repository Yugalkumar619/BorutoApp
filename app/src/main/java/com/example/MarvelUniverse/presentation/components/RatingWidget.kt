package com.example.MarvelUniverse.presentation.components
...
import com.example.MarvelUniverse.ui.theme.EXTRA_SMALL_PADDING
import com.example.MarvelUniverse.ui.theme.LightGray
import com.example.MarvelUniverse.ui.theme.StarColor
@Composable
fun RatingWidget(
    modifier: Modifier,
    rating: Double,
...
fun FilledStar(
    ...
    Canvas(modifier = Modifier.size(24.dp)){
        ...
        scale(scale = scaleFactor){
            ...
            val pathHeigth = starPathBounds.height
            val left = (canvasSize.width / 2) - (pathWidth / 1.7f)
            val top = (canvasSize.width / 2) - (pathWidth / 1.7f)
...
fun FilledStarPreview(){
    ...
    FilledStar(starPath = starPath, starPathBounds = startPathBounds, scaleFactor = 2.7f)
}
...
fun HalfFilledStarPreview(){
    ...
    HalfFilledStar(starPath = starPath, starPathBounds = startPathBounds, scaleFactor = 2.7f)
}
...
fun EmptyStarPreview(){
    ...
    EmptyStar(starPath = starPath, starPathBounds = startPathBounds, scaleFactor = 2.7f)
}
