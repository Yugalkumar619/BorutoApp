package com.example.MarvelUniverse.presentation.screens.details
...
import com.example.MarvelUniverse.presentation.components.InfoBox
import com.example.MarvelUniverse.presentation.components.OrderedList
import com.example.MarvelUniverse.ui.theme.*
import com.example.MarvelUniverse.util.Constants.ABOUT_TEXT_MAX_LINES
import com.example.MarvelUniverse.util.Constants.BASE_URL
import com.example.MarvelUniverse.util.Constants.MIN_BACKGROUND_IMAGE_HEIGHT
...
fun BottomSheetContent(
    ...
    Column(
        ...
        Row(
            ...
            Icon(
                modifier = Modifier
                    .size(INFO_ICON_SIZE)
                    .weight(2f),
                painter = painterResource(id = R.drawable.eye_mask),
        ...
        Row (
            ...
            InfoBox(icon = painterResource(id = R.drawable.fist),
